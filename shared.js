...
function insertChecklistItem(){
  ...
  const html=`<div class="cl-item" style="display:flex;align-items:flex-start;gap:6px;margin:3px 0"><input type="checkbox" class="cl-check" data-clid="${clid}" style="margin-top:3px;flex-shrink:0"><span>&nbsp;</span></div><div><br></div>`;
